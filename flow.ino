...
//  Serial.print(F("Duration="));Serial.println(duration);
  ...
  Calc = 612.2 * NbTopsFan/duration;  // YF-S401: F = 98 * Q in L/min converted to L/h 
                                      //      => 60 * tops/(98*millis/1000) = Q in L/h 
                                      //      => Q(in L/h) =  612.2 * tops/millis
...
/**
 * interrupt function to calculate rpm
 */
